-- JW Library userData.db schema, version 16.
-- Captured from a real backup; contains no personal data.
-- The two halves are separated so fixtures can seed the single
-- LastModified row before the trigger that forbids INSERT exists.
